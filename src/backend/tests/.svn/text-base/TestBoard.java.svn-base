...
public class TestBoard {
	...
	public void IndexOutofBoundExceptionInBoard() throws InvalidBoardSizeException{
		Point point= new Point(5,5);
		Board board = new Board("Tere", point);
	...
	@Test
	public void AbleToSetBoxinEmptyFloor() throws InvalidBoardSizeException, PositionOutOfBoundsException{
		Point point= new Point(5,5);
	...
	@Test
	public void SetSmileInMatrixofTile() throws InvalidBoardSizeException, PositionOutOfBoundsException{
		...
		assertTrue(((ContentOperations)board.getBoard()[smile.getPosition().x][smile.getPosition().y]).getContent() instanceof Smile);
...
/*	public static void main(String[] args) throws InvalidBoardSizeException, PositionOutOfBoundsException {

		Board board= new Board("My Board", new Point(10,10));
		Player myPlayer= new Player("Tere", 0);
		Game myGame= new Game(board, myPlayer, "Level1");
